      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          <div className="flex items-center justify-center mb-10">
            <div className="h-1 w-20 bg-gradient-to-r from-fuchsia-500 to-purple-600 rounded-full mr-6"></div>
            <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-500 to-purple-600">
              Why Choose Us
            </h2>
            <div className="h-1 w-20 bg-gradient-to-r from-purple-600 to-fuchsia-500 rounded-full ml-6"></div>
          </div>
